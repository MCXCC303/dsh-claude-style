...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "  /* The quote reads as a link: same blue, a wash of it for the fill, and the",
      "     same tone for the bar — the text colour itself is --dsh-claude-link. */",
      "  --dsh-claude-quote-bg: rgba(138, 180, 248, 0.12);",
      "  --dsh-claude-quote-border: rgba(138, 180, 248, 0.55);",
      ...
      "  /* Quote = link material (see the dark block). */",
      "  --dsh-claude-quote-bg: rgba(24, 79, 149, 0.08);",
      "  --dsh-claude-quote-border: rgba(24, 79, 149, 0.45);",
      "}",
      "",
      "body[data-dsh-claude-style]:not([data-ds-dark-theme]) {",
      "  color: #141413;",
      ...
      "}",
      "",
      "body[data-dsh-claude-style] [class*=\"markdown\"] th {",
      "  background: #f0f0ef;",
      "}",
      "",
      "body[data-dsh-claude-style][data-ds-dark-theme] [class*=\"markdown\"] th {",
      "  background: #242320;",
      "}",
      "",
      ...
      "body[data-dsh-claude-style] [class*=\"markdown\"] [class*=\"tableScroll\"] {",
      ...
      "",
      "/* ---------- editorial markdown ---------- */",
      "/* The quote wears the link's material: same blue, underlined at rest, on a wash",
      "   of that blue with a matching bar. A quote and a link are the same signal — a",
      "   passage that came from somewhere else — so they read as one material instead",
      "   of the neutral gray bar the quote used to carry. The prose face stays. */",
      ...
      "  border-left: 2px solid var(--dsh-claude-quote-border);",
      "  background: var(--dsh-claude-quote-bg);",
      "  border-radius: 0 8px 8px 0;",
      "  /* The host's `.markdown blockquote` sets padding-left on its own class, so",
      "     the box padding has to be pinned to keep the wash even on both sides. */",
      "  margin: 16px 0;",
      ...
      "   stable fragment. Same link material as anchors — the link blue, the same",
      "   weight, and the host's dotted underline on hover — with the chip's wash and",
      "   hairline recoloured to match. No underline at rest: inside a monospace chip",
      "   it collides with the descenders and the pill's own bottom edge, which is the",
      "   same reason the host keeps it hover-only. */",
      ...
      "  text-decoration: underline dotted var(--dsh-claude-link);",
      "  text-underline-offset: 3px;",
      "}",
      "",
      "body[data-dsh-claude-style] code:not(pre code):has(> :is([class*=\"_fileMention\"], a)) {",
      "  background: var(--dsh-claude-quote-bg);",
      "  border-color: var(--dsh-claude-quote-border);",
      "}",
      "",
      ...
      "body[data-dsh-claude-style][data-dsh-claude-composer-active]:not([data-ds-dark-theme]) [class*=\"composerStack\"]:has([class*=\"heroWorkspaceRow\"]) [data-composer-card],",
      ...
      "}",
      "",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active][data-ds-dark-theme] [class*=\"composerStack\"]:has([class*=\"heroWorkspaceRow\"]) [data-composer-card],",
      ...
      "}",
      "",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active]:not([data-ds-dark-theme]) [class*=\"composerStack\"]:has([class*=\"heroWorkspaceRow\"]) [data-composer-card]:focus-within,",
      ...
      "}",
      "",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active][data-ds-dark-theme] [class*=\"composerStack\"]:has([class*=\"heroWorkspaceRow\"]) [data-composer-card]:focus-within,",
      ...
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [class*=\"composerStack\"]:not(:has([class*=\"heroWorkspaceRow\"])) [data-composer-card][data-has-attachments=\"true\"] :is(button[aria-label^=\"发送\"], button[aria-label^=\"Send\"], button[aria-label*=\"发送\"], button[aria-label*=\"Send\"]) {",
