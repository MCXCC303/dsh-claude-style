...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "body[data-dsh-claude-style] [class*=\"_header_\"]:has([class*=\"_tabs_\"]) {",
      ...
      "   share one rule. */",
      "body[data-dsh-claude-style] [class*=\"_header_\"]:has([class*=\"_tabs_\"])::after {",
      "  content: \"\" !important;",
     ...
     * the plain fill for a dot-matrix that twinkles in the brand colour (the
     * grid is solved in whole device pixels, the phases scattered by hash, the
     * entrance swept in from the right, in the manner of the community
     * skin-switcher plugin), tints the knob, and colours the level's name.
     *
    ...
    function createEffortControl(opts) {
      ...
      function ensureMatrix() {
        ...
        /* Clay at rest, a lighter clay at the flash peak. Every block mixes
           its own peak between the two (k in [0.45, 0.95)), so the grid
           twinkles in a range of tones instead of one shared light. */
        var DEEP = [217, 119, 87]
        var LIGHT = [234, 171, 147]
        var PEAK = [246, 208, 188]
        var peak = []
