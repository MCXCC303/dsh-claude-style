...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "   rules key off the host's detailed button structure, so they carry the mode",
      "   marker; the compact row gets its own block further down. */",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]) {",
      "  gap: 0 !important;",
      "  justify-content: center !important;",
      "  font-family: var(--dsw-font-family) !important;",
      "  font-size: 12px !important;",
      ...
      "}",
      "",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]) svg {",
      "  display: none !important;",
      "}",
      "",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]) button > span {",
      "  display: none !important;",
      "}",
      "",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]) button {",
      "  padding: 0 !important;",
      "  border-radius: 0 !important;",
      "  background: transparent !important;",
      ...
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]) > span {",
      "  min-width: 0 !important;",
      "  overflow: hidden !important;",
      "}",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]) > span:first-child {",
      "  flex: 0 1 auto !important;",
      "}",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]) > span:last-child {",
      "  flex: 0 0 auto !important;",
      "}",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]) button {",
      "  display: block !important;",
      ...
      "}",
      "",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]) button:hover,",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]) button[aria-expanded=\"true\"] {",
      "  background: transparent !important;",
      "  color: var(--dsw-alias-label-secondary) !important;",
      "}",
      "",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]) > span:first-child button::after {",
      "  content: var(--dsh-stats-time, '');",
      "}",
      "",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]) > span:last-child button::after {",
      "  content: var(--dsh-stats-usage, '');",
      "}",
      "",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]) > span + span::before {",
      "  content: ' · ';",
      ...
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [class*=\"composerStack\"]:not([data-composer-variant=\"hero\"]) [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]) {",
      "  transition: background-color 0.12s ease;",
      "}",
      "",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [class*=\"composerStack\"]:not([data-composer-variant=\"hero\"]) [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]):hover {",
      "  background: var(--dsh-claude-hover-bg, rgba(0, 0, 0, 0.08)) !important;",
      "  border-radius: 6px !important;",
      "}",
      "",
