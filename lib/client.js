...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "   the titlebar, horizontally centred in the window and always visible — the",
      "   same row the host gives the collapsed sidebar's new-session button. The",
      "   measured --dsh-view-tabs-shift is not written in this mode, so the base",
      "   transform gives way. */",
      ...
      "  --dsw-menu-surface-fill: var(--dsw-alias-bg-overlay, #ffffff);",
