...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var MONO = "'JetBrains Mono',ui-monospace,'SF Mono','Fira Code',Consolas,'Liberation Mono',Menlo,Courier,monospace"
    ...
    var CSS = [
      ...
      "  --dsw-font-code: 'JetBrains Mono',ui-monospace,'SF Mono','Fira Code',Consolas,'Liberation Mono',Menlo,Courier,monospace;",
      ...
      "}",
      "",
      "/* Claude sets code blocks at the same size as body copy; the host sizes",
      "   pre/code itself, so force both to the surrounding body size. */",
      "body[data-dsh-claude-style] pre,",
      ...
      "}",
      "",
      "/* New-conversation composer: the card keeps its outline and the",
      "   card→footer-tray seam, but drops the fill and shadow. */",
      ...
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] :is([class*=\"composerHero\"], [data-phase=\"hero\"]) [data-composer-card] {",
      "  background: transparent !important;",
      "  box-shadow: none !important;",
      "}",
      "",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [class*=\"composerStack\"]:has([class*=\"heroWorkspaceRow\"]) [data-composer-card]:focus-within,",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] :is([class*=\"composerHero\"], [data-phase=\"hero\"]) [data-composer-card]:focus-within {",
      "  box-shadow: none !important;",
      "}",
      "",
      ...
      "  box-shadow: 0 0 0 1px rgba(20, 20, 19, 0.065), 0 0 0 6px var(--dsw-alias-bg-base), 0 0 16px 10px var(--dsw-alias-bg-base), 0 0 48px 16px var(--dsw-alias-bg-base) !important;",
      "}",
      ...
      "  box-shadow: 0 0 0 1px rgba(250, 249, 245, 0.09), 0 0 0 6px var(--dsw-alias-bg-base), 0 0 16px 10px var(--dsw-alias-bg-base), 0 0 48px 16px var(--dsw-alias-bg-base) !important;",
      "}",
