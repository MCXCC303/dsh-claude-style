...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "   workspace-view.js); the skin only adds the delete button, absolutely placed so",
      "   the host's row layout is untouched, and fades the row's timestamp out on hover",
      "   to make room for it. */",
      "body[data-dsh-claude-style] [data-dsh-claude-archive-row] {",
      "  position: relative !important;",
      "}",
      "body[data-dsh-claude-style] [data-dsh-claude-archive-row]:hover [class*=\"time\"] {",
      "  opacity: 0 !important;",
      "}",
