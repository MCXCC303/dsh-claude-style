...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      '  background: var(--dsh-claude-hover-bg, rgba(0, 0, 0, 0.08)) !important;',
      '}',
      'body[data-dsh-claude-style][data-ds-dark-theme] .dsh-claude-account-btn:hover,',
      'body[data-dsh-claude-style][data-ds-dark-theme] .dsh-claude-account-btn[data-open="true"] {',
      '  background: rgba(255, 255, 255, 0.08) !important;',
      '}',
    ...
    function getUsername(ctx) {
      ...
      try {
        if (ctx && typeof ctx.get === 'function') {
          var user = ctx.get('user') || ctx.get('account')
