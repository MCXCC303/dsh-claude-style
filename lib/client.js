...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "  opacity: 0 !important;",
      "  animation: dshClaudeEffortCellIn 0.15s ease forwards !important;",
      "}",
      ...
      function ensureMatrix() {
        ...
        for (var r = 0; r < lay.rows; r++) {
          for (var c = 0; c < lay.cols; c++) {
            ...
            cell.style.animationDelay = (((1 - fx) * 0.45) + cellUnit(r, c, 4) * 0.08).toFixed(3) + 's'
            ...
            sq.style.animationDelay = (cellUnit(r, c, 2) * 1.38 + 0.3).toFixed(3) + 's'
            sq.style.animationDuration = (1.45 * (0.92 + cellUnit(r, c, 3) * 0.16)).toFixed(3) + 's'
            cell.appendChild(sq)
