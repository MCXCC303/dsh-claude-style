...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "     so justify-self alone does it), and lifted 10px from its natural y=50.",
      "     It stays on its own row on purpose: the title's row also carries the header",
      "     actions — the background-task chip, the workspace/preset picker, the overflow",
      "     menu and the panel toggle — so centring the strip with the title put it on",
      "     top of them. */",
