...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "}",
      "/* Each wordmark's viewBox is cropped to its capitals, so the box's bottom edge is",
      "   the baseline and whatever the art draws above or below that band falls outside",
      "   it — DeepSeek's \"k\" ascender and its \"p\" descender. Overflow stays visible so",
      "   they paint anyway, exactly where a text ascender and descender would. */",
