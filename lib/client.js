...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "/* Token stats pills & dock line — positioned over the bottom toolbar row",
      "   without detaching nodes from their native React parents (preventing React",
      "   unmount DOMException / browser freeze). */",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [class*=\"composerStack\"]:not([data-composer-variant=\"hero\"]) {",
      "  position: relative !important;",
      "}",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [class*=\"composerStack\"]:not([data-composer-variant=\"hero\"]) [class*=\"dock\"] {",
      "  position: absolute !important;",
      ...
      "  padding: 0 160px 0 140px !important;",
      "  display: flex !important;",
      "  align-items: center !important;",
      "  justify-content: center !important;",
      "  gap: 12px !important;",
