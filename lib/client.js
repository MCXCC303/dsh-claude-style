...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "  right: 0 !important;",
      "  top: 50% !important;",
      "  /* Claude's real Effort slider reads as one chunky pill the knob rides IN:",
      "     the groove is 26px tall, the capsule knob 30px — it pokes 2px out top and",
      "     bottom. (The first pass at this control was 6px, a thin rail; 14px was an",
      "     intermediate groove. 26px matches the reference.) */",
      "  height: 26px !important;",
      "  margin-top: -13px !important;",
      "  border-radius: 999px !important;",
      "  /* A pill: its caps are meant to be round, and the page inherits superellipse",
      "     corners from <html>. */",
      "  corner-shape: round !important;",
      ...
      "  transition: transform 0.18s cubic-bezier(0.22, 0.61, 0.36, 1), background-color 0.3s ease, box-shadow 0.3s ease !important;",
