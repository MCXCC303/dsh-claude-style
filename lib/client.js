...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "     matrix block colours are computed in model-effort.js against the same",
      "     ramp, so this token and those constants move together. */",
