...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "  background: color-mix(in srgb, var(--dsw-alias-label-primary, #141413) 26%, transparent) !important;",
      "}",
      "/* The top rung's dot matrix: a grid of brand blocks floating on the bare",
      ...
      "   a COLOUR change, from clay to a lighter clay, because a mere opacity dip",
      ...
      "  /* One flash cycle: hold clay 250ms, jump to the block's lighter peak 480ms,",
      ...
      "  0%, 17.24% { background-color: var(--dsw-alias-brand-primary, #d97757); }",
      "  17.25%, 50.34% { background-color: var(--dsh-flash-light, #eab695); }",
      "  100% { background-color: var(--dsw-alias-brand-primary, #d97757); }",
      "}",
      "/* Reaching the top rung: the plain fill and the ticks hand the groove over to",
      "   the matrix, the knob takes a brand tint and a soft glow, and the level's",
      "   name goes clay. */",
      ...
      "  background: color-mix(in srgb, var(--dsw-alias-brand-primary, #d97757) 22%, var(--dsw-static-neutral-bluish-00, #ffffff)) !important;",
      "  box-shadow: 0 0 10px color-mix(in srgb, var(--dsw-alias-brand-primary, #d97757) 80%, transparent), 0 0 0 1px color-mix(in srgb, var(--dsw-alias-brand-primary, #d97757) 35%, transparent) !important;",
      "}",
