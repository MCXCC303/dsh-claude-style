...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "  width: auto !important;",
      "  max-width: none !important;",
      "  /* Auto width, centered: the sentence hugs its own text (so the hover plate",
      "     covers the text and not the whole row) and the auto margins centre it in",
      "     the air between the left tool cluster and the trailing model group. */",
      ...
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [data-composer-card] [class*=\"_row\"] [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]) {",
      "  transition: background-color 0.12s ease;",
      "}",
      "",
      "body[data-dsh-claude-style][data-dsh-claude-composer-active] [data-composer-card] [class*=\"_row\"] [data-composer-stats]:not([data-dsh-claude-stats-mode=\"compact\"]):hover {",
      "  background: var(--dsh-claude-hover-bg, rgba(0, 0, 0, 0.08)) !important;",
      "  border-radius: 6px !important;",
      "}",
      "",
