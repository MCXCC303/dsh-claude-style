...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "  overflow: visible !important;",
      "}",
      "body[data-dsh-claude-style] .dsh-claude-model-combine .dsh-combine-mark-color {",
      "  display: none !important;",
      "}",
