 ...
 * and no path traversal is possible. The JetBrains Mono files and the Gemini
 * picker face ship in the npm package; the Anthropic faces do not (copyright) —
 * their entries exist so a user-supplied copy in `fonts/` is served, and
 * readFileSync's ENOENT turns into a 404 the browser half's font stacks fall
 * back from.
 */
const FONT_FILES = {
  ...
  'GoogleSansFlexPicker.woff2': 'font/woff2',
}
